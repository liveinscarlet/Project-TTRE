...
if __name__ == "__main__":
    ...
    for i in voltages:
        ...
        for j in voltages:
            ...
            # Save waveforms
            np.savetxt(fr"C:\Projects\Project-TTRE\Waveforms\Neg_3SRD\amplsV{[i]}_V{j}.csv", ampl, delimiter=",")
            np.savetxt(fr"C:\Projects\Project-TTRE\Waveforms\Neg_3SRD\times_V1{i}_V2{j}.csv", times, delimiter=",")
    ...
    # Save data
    np.savetxt(r"C:\Projects\Project-TTRE\Waveforms\Neg_3SRD\ampls.csv", max_amp, delimiter=",")
    np.savetxt(r"C:\Projects\Project-TTRE\Waveforms\Neg_3SRD\width.csv", pulse_width, delimiter=",")
    np.savetxt(r"C:\Projects\Project-TTRE\Waveforms\Neg_3SRD\width_short.csv", pulse_width_full01, delimiter=",")
    np.savetxt(r"C:\Projects\Project-TTRE\Waveforms\Neg_3SRD\width_long.csv", pulse_width_short07, delimiter=",")
    np.savetxt(r"C:\Projects\Project-TTRE\Waveforms\Neg_3SRD\wtime_max_ampl.csv", time_max_ampl, delimiter=",")
